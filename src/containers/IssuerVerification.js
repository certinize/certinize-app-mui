          ...
          >
            <div>
              ...
              >
                <b>
                  {" "}
                  With Certinize, people do not have to verify certificates.
                  They only need to validate the issuing body, your
                  organization.
                </b>{" "}
                It means to find out if a wallet address used to issue a
                certificate belongs to an organization.
              </Typography>
            </div>
            <div>
              <Typography
            ...
            <div>
              ...
              <Typography variant="subtitle2" sx={{ width: "94%" }}>
                <ul>
                  <li>
                    <b style={{ color: "#1A799D" }}>Google Trends:</b> A profile
                    on Google Trends with evidence of recent search activity
                    about you.
                  </li>
                  <li>
                    <b style={{ color: "#1A799D" }}>Wikipedia article:</b> A
                    Wikipedia article that is about you and meets their
                    notability standards for people.
                  </li>
                  <li>
                    <b style={{ color: "#1A799D" }}>Public stock exchange:</b> A
                    link providing evidence of substantial presence in a public
                    stock exchange.{" "}
                  </li>
                </ul>
              </Typography>
            ...
            <div>
              <Typography
                variant="body2"
                sx={{ color: "#1A799D", fontWeight: "bold", padding: 2 }}
              >
                3. Official Website
              </Typography>
              ...
              <Typography
                variant="subtitle2"
                sx={{ marginLeft: 3, width: "90%" }}
              >
                Provide the link to an official website that refences your
